...
class AppointmentView(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        #     recipient_list=['stardust1000@yandex.ru', 'starschinowa.ana@gmail.com']  # здесь список получателей. Например, секретарь, сам врач и т. д.
        # )
        ...
        #     from_email='starschinowa.anastasia@yandex.ru',
        #     to=['stardust1000@yandex.ru', 'starschinowa.ana@gmail.com'],  # это то же, что и recipients_list
        # )
